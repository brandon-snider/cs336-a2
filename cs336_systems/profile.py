...
from cs336_systems.common import MODEL_SIZES, BATCH_SIZE, VOCAB_SIZE
...
def main():
    ...
    parser.add_argument("--include_backward", action="store_true", help="Include backward pass")
    parser.add_argument("--include_step", action="store_true", help="Include optimizer step")
    parser.add_argument("--include_zero_grad", action="store_true", help="Include zero_grad")
    ...
    for size in sizes:
        for seq_len in seq_lens:
            print(f"Profiling size={size}, seq_len={seq_len} on cuda")
